...
const Navbar = (props) => {
        const { loginUserType, loginPage, studentPage } = props;
                        ...
                        <nav className="bg-white shadow-md px-4 sm:px-6 lg:px-8 py-3">
                                <div className="max-w-7xl mx-auto flex justify-between items-center">
                                        ...
                                        <div className="hidden md:block">
                                                ...
                                                <div className={"loginItems ml-10 flex items-center space-x-4" + (loginPage ? "" : " hidden")}>
                                                        ...
                                                        {loginUserType != "student" && <NavLink to={'../login/student'} className="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md font-medium">Student</NavLink>}
                                                ...
                                                {/* student options  */}
                                                <div className={"studentItems ml-10 flex items-center space-x-4" + (studentPage ? "" : " hidden")}>
                                                        <NavLink to={'../student/panel'} className="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md font-medium">Dashboard</NavLink>
                                                        <NavLink to={'../student/previousTransactions'} className="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md font-medium">Transactions</NavLink>
                                                        <button
                                ...
                                <div className={"md:hidden " + (isHidden ? "hidden" : "")}>
                                        ...
                                        <div className={"flex flex-col min-w-30 absolute bg-indigo-700 right-5 rounded text-white px-2 pt-2 pb-3 space-y-1 sm:px-3" + (loginPage ? "" : " hidden")}>
                                                ...
                                                {loginUserType != "student" && <NavLink to={'../login/student'} className=" hover:text-blue-600 px-3 py-2 rounded-md font-medium">Student</NavLink>}
                                        ...
                                        <div className={"flex flex-col min-w-30 absolute bg-indigo-700/95 right-5 rounded text-white px-2 pt-2 pb-3 space-y-1 sm:px-3" + (studentPage ? "" : " hidden")}>
                                                <NavLink to={'../student/panel'} className=" hover:text-blue-600 px-3 py-2 rounded-md font-medium">Dashboard</NavLink>
                                                <NavLink to={'../student/previousTransactions'} className=" hover:text-blue-600 px-3 py-2 rounded-md font-medium">Transactions</NavLink>
                                                <button
                                                onClick={handleLogout}
